...
if __name__ == '__main__':
    model = ByT5Model()
    model.load_model(model_dir="/experiments/ahughes/character_only_llm/outputs/simplet5-epoch-2-train-loss-0.0551-val-loss-0.0882")
    # train
...
# """)
    # train
    result = model.predict("""restore: rahul gandhi has replied to goa cm manohar parrikars letter 
which accused the congress president of using his visit to an ailing man for political gains 
