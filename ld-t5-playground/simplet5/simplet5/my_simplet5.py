...
class SimpleT5:
    ...
    def from_pretrained(self, model_name="byt5-small") -> None:
        """ Load ByT5 model for training/finetuning

        Args:
          model_name (str, optional): Model architecture name. The following models are available:
            byt5-small      300M parameters     https://huggingface.co/google/byt5-small
            byt5-base       582M parameters     https://huggingface.co/google/byt5-base
            byt5-large      1.23B parameters    https://huggingface.co/google/byt5-large
            byt5-xl         3.74B parameters    https://huggingface.co/google/byt5-xl
            byt5-xxl        12.9B parameters    https://huggingface.co/google/byt5-xxl
        """
        
        available_models = [f"byt5-{size}" for size in ['small', 'base', 'large', 'xl', 'xxl']]
        if model_name not in available_models:
            raise ValueError(
                f"model_name must be one of the following: {', '.join(available_models)}. " +\
                "Not {model_name}."
            )
